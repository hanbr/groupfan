...
public interface GoodsDao extends BaseDao<Goods> {
    ...
    @Select("SELECT a.goods_id as goodsId,a.goods_name as goodsName,a.goods_desc as goodsDesc,a.goods_kind as goodsKind,a.price," +
            ...
            "where a.is_release=#{isRelease} and a.user_id = #{userId} ORDER BY a.release_date desc")
    List<Goods> getGoodsListByUser(@Param("userId") Long userId,@Param("isRelease") boolean isRelease);
